...
## The UberDDR3 controller clock is the framework's hr domain (single clock,
## no CDC in the Avalon memory chain); clk_m2m's 100 MHz output is unused
create_generated_clock -name hr_clk         [get_pins i_framework/i_ddr3_wrapper/i_mmcm_ddr3/CLKOUT2]
